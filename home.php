            ...
            <div class="col-md-8">
                <form id="carbon-calculator-form">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="km" placeholder="Enter the kilometers you drive per month">
                    </div>
...
document.getElementById('carbon-calculator-form').addEventListener('submit', function(event) {
    ...
    const kmFactor = 0.404; // kg CO2 per km

    const totalCarbon = (electricity * electricityFactor) + (gas * gasFactor) + (km * kmFactor);
...
<!-- how-to section -->
<section class="services-section" id="how-to">
    <div class="container">
        <div class="row">
            <!-- Teks di kanan -->
            <div class="col-lg-6 col-md-12 col-sm-12 text-content">
                <h1>Cara Efektif Menurunkan Jejak Karbon di Kehidupan Sehari-Hari</h1>
                <p>Mengurangi jejak karbon adalah langkah penting untuk melindungi lingkungan dan memperlambat perubahan iklim. Berikut adalah beberapa cara praktis yang dapat Anda lakukan:</p>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 services">
                <div class="row row1">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="card">
                                <img src="images/home.jpg" class="card-img-top" alt="..." style="width: 35%; height: auto;">
                                <div class="card-body">
                                    <h4 class="card-title">Hemat Energi di Rumah</h4>
                                    <p class="card-text">Gunakan perangkat hemat energi: Ganti lampu pijar dengan lampu LED.</p>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Pilih Transportasi Ramah Lingkungan</h4>
                                    <p class="card-text">Gunakan transportasi umum, kendaraan listrik, atau berbagi kendaraan.</p>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="row row2">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="card">
                                <img src="images/solar panel.png" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h4 class="card-title">Dukung Energi Terbarukan</h4>
                                    <p class="card-text">Pasang panel surya atau pilih penyedia energi bersih.</p>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <a href="windpower.php" class="card-link">
                            <div class="card">
                                <img src="images/reforest.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h4 class="card-title">Tanam Pohon atau Dukung Reforestasi</h4>
                                    <p class="card-text">Ikut serta dalam proyek penanaman pohon: Satu pohon dapat menyerap hingga 22kg CO2 per tahun.</p>
                                </div>
                            </div>
                        </a>
                    </div>
